...
| [steamcmd-bases](https://github.com/mbround18/steamcmd-bases) | 🚧 | `deployer.yaml`/`tagger.yaml` → `paws docker`/`paws semver`, PR [#15](https://github.com/mbround18/steamcmd-bases/pull/15) open and green, awaiting merge. `test-compatibility.yml` (not `gh-reusable`-based) deliberately left untouched. |
